...
/*
 * Write a Java program to test whether a given double/float value is a
 * finite floating-point value or not.
 * Напишите программу на Java, чтобы проверить, является ли данное
 * значение типа double / float конечным значением с плавающей запятой или нет.*/
