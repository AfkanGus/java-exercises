...
/*
* Напишите программу на Java для извлечения значения примитивного типа из
* заданного значения BigInteger.
* Write a Java program to extract the primitive
* - type value from a given BigInteger value.*/